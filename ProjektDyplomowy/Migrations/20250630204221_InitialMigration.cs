    ...
    public partial class InitialMigration : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_YachtFavorite", x => x.Id);
                    table.ForeignKey(
                        name: "FK_YachtFavorite_AspNetUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_YachtFavorite_Yacht_YachtId",
                        column: x => x.YachtId,
                        principalTable: "Yacht",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_YachtFavorite_UserId",
                table: "YachtFavorite",
                column: "UserId");

            migrationBuilder.CreateIndex(
                name: "IX_YachtFavorite_YachtId",
                table: "YachtFavorite",
                column: "YachtId");
        }
