...
namespace ProjektDyplomowy.Controllers
{
    public class OwnersController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("UserId")] Owner owner)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(string id, [Bind("UserId")] Owner owner)
        {
            if (id != owner.UserId)
            {
                return NotFound();
        ...
        {
            return _context.Owner.Any(e => e.UserId == id);
        }
    }
}
